...
export const fetchList = async (dispatch, data) => {
  try {
    ...
    var apiRes = await services.fetchList(data);
    dispatch({
...
export const deletePost = async (dispatch, data) => {
  try {
    loaderStart(dispatch);
    var apiRes = await services.delPost(`posts/${data.id}`);
    dispatch({
...
export const createPost = async (dispatch, data) => {
  try {
    loaderStart(dispatch);
    var apiRes = await services.createPost(data);
    dispatch({
...
export const updatePost = async (dispatch, data) => {
  try {
    loaderStart(dispatch);
    var apiRes = await services.updatePost(data);
    dispatch({
